...
public class ProgramAdapter extends RecyclerView.Adapter<ProgramAdapter.ViewHolder> {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void setData(Users current) {
            ...
            this.brukerDesc.setText(current.getUserInfo());
            this.brukerBosted.setText("Bosted: " +current.getLivingPlace());
            this.brukerAlder.setText("Alder: "+ current.getAlder());

                String posterUrl= current.getBildet();

                if(posterUrl != null && !posterUrl.equals("")){
                    Glide.with(brukerBilde.getContext())
                        .load(posterUrl)
                         .into(brukerBilde);
                }
                else
                    brukerBilde.setImageResource(R.drawable.bilde);
